...
class TestTemplateRegistry:
    ...
    def test_find_by_hash(self, tmp_path):
        ...
        registry = TemplateRegistry(tmp_path)
        m = TemplateManifest(template_id="t1", name="test", source_hash="abc123")
        registry.register(m)
    ...
    def test_unregister_removes_from_index(self, tmp_path):
        ...
        registry = TemplateRegistry(tmp_path)
        m = TemplateManifest(template_id="t1", name="test", source_hash="abc")
        registry.register(m)
    ...
    def test_hash_index_updated_on_reregister(self, tmp_path):
        ...
        registry = TemplateRegistry(tmp_path)
        m1 = TemplateManifest(template_id="t1", name="test 1", source_hash="abc")
        m2 = TemplateManifest(template_id="t2", name="test 2", source_hash="abc")
...
class TestPopFix:
    ...
    def test_set_reference_does_not_mutate_input(self):
        ...
        gen = PPTAgent(language_model=MagicMock(), vision_model=MagicMock())
